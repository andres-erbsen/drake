...
void Albatross<T>::DoCalcTimeDerivatives(
  ...
  const double windspeed_gradient = 0; // .02 bottom edge of jetstrem at 5km..
  ...
  //unused: const T altitude = context.get_continuous_state().get_generalized_position().GetAtIndex(3);
